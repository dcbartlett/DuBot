...
```
git clone --depth=1 https://github.com/theguy404/DuBot.git <project_name>
```
...
# TypeScript + Node 
Dubot was created to fill the void of a lot of the discord bots out there...Reliability and easy expandability.
